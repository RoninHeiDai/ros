...
if("TRUE" STREQUAL "TRUE")
  set(learning_service_SOURCE_PREFIX /home/heidai/ws/src/learning_service)
  set(learning_service_DEVEL_PREFIX /home/heidai/ws/devel)
  ...
  set(learning_service_INSTALL_PREFIX /home/heidai/ws/install)
...
if(NOT "/home/heidai/ws/devel/include " STREQUAL " ")
  set(learning_service_INCLUDE_DIRS "")
  set(_include_dirs "/home/heidai/ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'learning_service' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/heidai/ws/src/learning_service/${idir}'.  ${_report}")
    endif()
